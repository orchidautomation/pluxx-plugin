...
> Dry-run a GitHub release for version 0.2.2, including installers and checksums, but do not upload anything.
...
```bash
pluxx publish --github-release --version 0.2.2 --allow-dirty --dry-run
```
